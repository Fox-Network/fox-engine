...
execute if score @s Arctic matches 0 if entity @e[tag=!fox1] unless entity @e[tag=fox1] run summon fox ~ ~ ~ {Invulnerable:1b,PersistenceRequired:1b,NoAI:1b,Type:"red",Rotation:[-180F,0F],Tags:["fox1"]}
function foxengine:transform